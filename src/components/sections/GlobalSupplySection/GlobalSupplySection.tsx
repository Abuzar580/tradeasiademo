...
const GLOBAL_SUPPLY_FEATURES: FeatureCard[] = [
  {
    iconSrc: "/stackIcon.svg",
    value: "20+",
    label: "Years Experience",
  },
  {
    iconSrc: "/globeBlue.svg",
    value: "Global",
  ...
  return (
    ...
    <div className="relative z-10 layout-container flex flex-col items-center gap-7 md:gap-15">
        ...
        {GLOBAL_SUPPLY_FEATURES.map((feature) => (
            ...
            >
              <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-[var(--brand-white)] md:h-12 md:w-12">
                <Image
                  src={feature.iconSrc}
                  alt=""
                  width={24}
              ...
              <div className="flex flex-col items-start text-[length:var(--body-small-size)] leading-[var(--body-caption-line-height)] font-[var(--font-weight-semibold)] text-[var(--brand-white)]
              md:text-[length:var(--heading-4-size)] md:leading-[var(--heading-4-line-height)]">
                <span>{feature.value}</span>
                <span className="text-[length:var(--body-caption-size)] md:text-[length:var(--body-small-size)] md:leading-[var(--body-caption-line-height)]">
                  {feature.label}
                </span>
              </div>
            </div>
